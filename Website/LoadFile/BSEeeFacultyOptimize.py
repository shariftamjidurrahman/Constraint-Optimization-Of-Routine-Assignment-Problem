import pandas as pd
import random
template = pd.read_excel('BSEEE-Full-Routine.xlsx')
teachers = pd.read_excel('Teachers-BSEEE.xlsx')
rooms=pd.read_excel('Room-info.xlsx')
sections=pd.read_excel('Sections-info-BSEEE.xlsx')
...
dataOut.to_excel("output-BSEEE-Faculty.xlsx")
